...
import { useAddCustomerMutation, useGetAllCustomersQuery, useUpdateCustomerMutation } from "../customersApiSlice"


const SingleCustomer = () => {
    const { userId } = useParams()
    const { data: users, isLoading, isError, error, isSuccess } = useGetAllCustomersQuery()
    const [updateUser, { isSuccess: isUpdateSuccess }] = useUpdateCustomerMutation()
